...
class NewUserForm(UserCreationForm):
    ...
    """ Vamos a sobreescribir el metodo save """ #se hace por defecto para crear un usuario
    def save(self, commit=True):
        user = super(NewUserForm, self).save(commit=False) #super hereda los metodos de newuserform
        # aumentar el email
